...
|------|---------|----------|
| Generic skill | `{technology}` | `vitest`, `zustand-5`, `typescript` |
| Feature skill | `{feature}-{component}` | `html5-qrcode`, `framer-motion` |
| Testing skill | `{tool}-{type}` | `vitest`, `react-testing-library` |
